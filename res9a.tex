...
{\sl Languages \& Software:\/} Python, Javascript, HTML, CSS, Shell scripting, \\
...
{\sl Frameworks \& toolkits:\/} Django, Vue, Angular, GTK+, Bootstrap\\
{\sl Development tools:\/} git, Jenkins, Github, Gitlab, Sentry\\
{\sl Systems administration:\/} Linux, AWS, NGINX, Apache,
PostgreSQL, MySQL, Redis, Ansible, Salt, ELK \\
{\sl Game development:\/} Light knowledge of Blender and Godot
