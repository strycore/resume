...
\begin{itemize} \itemsep -2pt
    \item Contributed to the open source e-commerce platform Shuup, built with Django
    \item Built new features for the platforms such as add-on signing and multiple shop support.
    \item Used Scrapy and custom made scripts to fetch data for an internal project.
\end{itemize}

{\sl Founder\/} \hfill 2015--present\\
Lunchcraft.net, Los Angeles
\begin{itemize} \itemsep -2pt
    \item Started a kitchen management platform aiming for recipe recommendations and optimal pantry usage
    \item Built a responsive frontend using Polymer, providing a native-like experience on all devices
